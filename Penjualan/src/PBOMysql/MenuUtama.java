...
public class MenuUtama extends javax.swing.JFrame {
    ...
    private void tampil_databarang() throws SQLException{
        ...
        res = stm.executeQuery("select * from barang");
        while (res.next()) {
    ...
    private void tampil_datatransaksi() throws SQLException{
        ...
        stm = conn.createStatement();
        res = stm.executeQuery("select * from temporary_jual");
        while (res.next()) {
            tmodel.addRow(new Object[]{res.getString("kode_brg"),
                res.getString("nama_brg"),
                res.getString("satuan_brg"),
    ...
    private void tampil_penjualan() throws SQLException{
        ...
        stm = conn.createStatement();
        res = stm.executeQuery("select * from penjualan");
        while (res.next()) {
    ...
    private void simpan_datapelanggan() throws SQLException{
        pstm = conn.prepareStatement("insert into pelanggan"
    ...
    private void update_datapelanggan() throws SQLException{
         pstm = conn.prepareStatement("update  pelanggan set nama_pelanggan='"+nm_pel.getText()
    ...
    private void hapus_datapelanggan() throws SQLException{ 
        pstm = conn.prepareStatement("delete from pelanggan where kode_pelanggan = '"+kd_pel.getText()+"'");
    ...
    private void simpan_databarang() throws SQLException{ 
        pstm = conn.prepareStatement("insert into barang"
    ...
    private void update_databarang() throws SQLException{
        pstm = conn.prepareStatement("update  barang set nama_brg='"+nm_brg.getText()
    ...
    private void hapus_databarang() throws SQLException{ 
        pstm = conn.prepareStatement("delete from barang where kode_brg = '"+kd_brg.getText()+"'");
    ...
    private void simpan_datatransaksi() throws SQLException{
        pstm = conn.prepareStatement("insert into temporary_jual"
    ...
    private void jumlah_barang() throws SQLException{
        stm = conn.createStatement();
        res = stm.executeQuery("select * from barang where kode_brg= '" + xkdbrg.getText() + "'");
        if (res.next()) {
            ...
            pstm = conn.prepareStatement("update barang set jml_brg='"+""+sisastock+"' where kode_brg = '"+xkdbrg.getText()+"'");
            if (pstm.executeUpdate()>0){
            }else{
            }
        }
    ...
    private void nofaktur() {
        try {
            stm = conn.createStatement();
            res = stm.executeQuery("select * from penjualan order by nomor_faktur desc");
            if (res.next()) {
    ...
    private void exitbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitbuttonActionPerformed
        // TODO add your handling code here:
        int pesan = JOptionPane.showConfirmDialog(null, "Are you sure?", "confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        switch (pesan) {
    ...
    private void xkdpelKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_xkdpelKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                ...
                res = stm.executeQuery("select * from pelanggan where kode_pelanggan = '" + xkdpel.getText() + "'");
                if (res.next()) {
    ...
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButtonActionPerformed
        try {
            ...
            res = stm.executeQuery("select * from temporary_jual");
            while (res.next()) {
                pstm = conn.prepareStatement("insert into penjualan"
    ...
    private void kd_brgKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kd_brgKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                stm = conn.createStatement();
                //System.out.println("koneksi berhasil;");
                res = stm.executeQuery("select * from barang where kode_brg= '" + kd_brg.getText() + "'");
                if (res.next()) {
    ...
    private void Laporan_PelangganActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Laporan_PelangganActionPerformed
        // TODO add your handling code here:
       try {
            File namafile = new File("src/Laporan/report_pelanggan.jrxml");
